...
// Copyright (C) 2018-2023 SwapDEX Network.
...
use sp_runtime::{
    ...
    traits::{
        self, BlakeTwo256, Block as BlockT, ConvertInto, NumberFor, OpaqueKeys, PostDispatchInfoOf,
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("swapdex"),
    impl_name: create_runtime_str!("swapdex"),
    authoring_version: 0,
...
const AVERAGE_ON_INITIALIZE_RATIO: Perbill = Perbill::from_perthousand(25);
...
parameter_types! {
    ...
    pub const SlashDeferDuration: sp_staking::EraIndex = 27; // 1/2 the bonding duration.
...
parameter_types! {
    ...
    pub const ProposalBondMinimum: Balance = 2 * DOLLARS;
...
pub struct DealWithBurn;
impl OnUnbalanced<NegativeImbalance> for DealWithBurn {
    fn on_nonzero_unbalanced(amount: NegativeImbalance) {
        let account: AccountId32 =
            hex_literal::hex!["64eaccb7c9cb3209d496bf39e1fe4a8b51ff11fd1dd3a7b3df1f32b1ba7cb950"]
                .into();
...
impl pallet_treasury::Config for Runtime {
    ...
    type Burn = Burn;
    // We set the destination to the Operation Address
    type BurnDestination = DealWithBurn;
...
parameter_types! {
  pub const BridgeChainId: u8 = 170;
...
impl starkley_bridge_transfer::Config for Runtime {
    type Event = Event;
...
parameter_types! {
    pub Prefix: &'static [u8] = b"Pay SDX to the SDX account:";
}

// pallet claims
parameter_types! {
    pub ClaimMessagePrefix: &'static [u8] = b"I hereby claim all my SDX tokens to wallet:";
}
...
pub struct StkGasWeightMapping;

impl pallet_evm::GasWeightMapping for StkGasWeightMapping {
...
impl pallet_evm::Config for Runtime {
    ...
    type GasWeightMapping = StkGasWeightMapping;
    ...
    type OnChargeTransaction = pallet_evm::EVMCurrencyAdapter<Balances, EvmDealWithFees>;
...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic
    {
        ...
        BridgeTransfer: starkley_bridge_transfer::{Pallet, Call, Event<T>},
