...
use swapdex_runtime::{
    constants::currency::*, pallet_claims::EthereumAddress, wasm_binary_unwrap,
    AuthorityDiscoveryConfig, BabeConfig, BalancesConfig, Block, ClaimsConfig, CouncilConfig,
    DemocracyConfig, EVMConfig, ElectionsConfig, EthereumConfig, GrandpaConfig, ImOnlineConfig,
    IndicesConfig, MaxNominations, SessionConfig, SessionKeys, StakerStatus, StakingConfig,
...
pub use swapdex_runtime::GenesisConfig;
...
/// Swapdex Phoenix generator
pub fn phoenix_swapdex_config() -> Result<ChainSpec, String> {
    ChainSpec::from_json_bytes(&include_bytes!("../res/phoenix.json")[..])
}

/// Swapdex generator
pub fn swapdex_config() -> Result<ChainSpec, String> {
    ChainSpec::from_json_bytes(&include_bytes!("../res/swapdex.json")[..])
}

/// Swapdex Kusari generator
pub fn kusari_swapdex_config() -> Result<ChainSpec, String> {
    ChainSpec::from_json_bytes(&include_bytes!("../res/kusari.json")[..])
}
...
pub fn testnet_genesis(
    ...
    GenesisConfig {
        ...
        babe: BabeConfig {
            authorities: vec![],
            epoch_config: Some(swapdex_runtime::BABE_GENESIS_EPOCH_CONFIG),
        },
...
pub fn create_testnet_claims() -> Vec<(EthereumAddress, Balance)> {
    ...
    // Message: "I hereby claim all my TSDX tokens to wallet:d43593c715fdd31c61141abd04a99fd6822c8558854ccde39a5684e7a56da27d"
    let claim_address_1 = (
        ...
        EthereumAddress(hex!["2F8b983Dba971ea6AE036FeD537b22B211aBacfD"]),
        1000000000000000,
    );
    let claim_address_2 = (
        EthereumAddress(hex!["1c3297e91d30Efc865FA7cE0FcFD03a4CFDb835e"]),
        1000000000000000,
    );
