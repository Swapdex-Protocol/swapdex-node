...
//! Utilities to build a `TestClient` for `swapdex-runtime`.
...
/// Call executor for `swapdex-runtime` `TestClient`.
pub type ExecutorDispatch =
    sc_executor::NativeElseWasmExecutor<node_cli::service::ExecutorDispatch>;
...
pub type Client = client::Client<
    ...
    swapdex_runtime::RuntimeApi,
>;

/// Transaction for swapdex-runtime.
