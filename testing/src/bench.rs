...
// Copyright (C) 2019-2023 SwapDEX Network.
        ...
        let signed = self.keyring.sign(
            CheckedExtrinsic {
                signed: CheckedSignature::Signed(
                    sender,
                    signed_extra(0, swapdex_runtime::ExistentialDeposit::get() + 1),
                ),
                function: match self.content.block_type {
                    BlockType::RandomTransfersKeepAlive => {
                        Call::Balances(BalancesCall::transfer_keep_alive {
                            dest: sp_runtime::MultiAddress::Id(receiver),
                            value: swapdex_runtime::ExistentialDeposit::get() + 1,
                        })
                    }
                    BlockType::RandomTransfersReaping => {
                        Call::Balances(BalancesCall::transfer {
                            ...
                            value: 100 * DOLLARS - (swapdex_runtime::ExistentialDeposit::get() - 1),
                        })
                    }
...
impl BenchKeyring {
    ...
    pub fn generate_genesis(&self) -> swapdex_runtime::GenesisConfig {
        crate::genesis::config_endowed(
            Some(swapdex_runtime::wasm_binary_unwrap()),
